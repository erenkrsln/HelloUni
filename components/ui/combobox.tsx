          ...
          <div className="max-h-[300px] overflow-auto">
            {options.map((option) => (
              <button
                ...
                type="button"
                className="flex w-full cursor-pointer select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors hover:bg-muted focus:bg-muted"
