  ...
  return (
    <div className="p-4 animate-in fade-in slide-in-from-bottom-2">
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-xl font-semibold text-foreground">Group Events</h2>
          <p className="text-sm text-muted-foreground">Upcoming events created for this group workspace.</p>
        </div>
        <button
      ...
      {events === undefined ? (
        <div className="rounded-3xl border border-border bg-card p-8 text-center text-muted-foreground shadow-sm">Loading events…</div>
        ...
        <div className="rounded-3xl border border-dashed border-border bg-card p-8 text-center text-muted-foreground shadow-sm">
          ...
          <p className="text-sm text-muted-foreground mt-2">Create a group event so members can stay aligned and join the next study session.</p>
        </div>
      ) : (
        <div className="space-y-3">
          {groupEvents.map((event) => (
            <Link
              ...
              className="group block rounded-3xl border border-border bg-card p-4 shadow-sm transition hover:border-accent hover:shadow-md"
            >
