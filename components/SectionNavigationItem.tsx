...
const SectionNavigationItem = ({
  ...
  return (
    ...
    >
      <span className={`text-[11px] font-bold leading-normal text-black text-left transition-opacity duration-300 ease-[cubic-bezier(0.44,0,0.56,1)] whitespace-pre-line ${isActive ? 'opacity-100' : isHovered ? 'opacity-[0.65]' : 'opacity-[0.42]'}`}>
        {label}
      </span>
