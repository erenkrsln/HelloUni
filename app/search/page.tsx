...
export default function SearchPage() {
    ...
    // Queries
    const userResults = useQuery(api.queries.searchProfiles, { searchTerm: debouncedQuery });
    const postResults = useQuery(api.queries.searchPosts, { searchTerm: debouncedQuery, userId: currentUserId });
                ...
                <div className="px-4 py-6">
                    ...
                    {!debouncedQuery ? (
                        <div className="flex flex-col items-center justify-center py-12 text-gray-400">
                            ...
                            <p>Suche nach Personen oder Beiträgen</p>
                        </div>
                    ) : (
