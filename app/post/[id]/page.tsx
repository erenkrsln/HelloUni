...
export default function PostPage() {
  ...
  return (
    <main className="min-h-screen w-full max-w-[428px] md:max-w-3xl mx-auto pb-24 header-spacing overflow-x-hidden bg-muted/50">
      ...
      <div className="pt-4">
        {post === undefined ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
            ...
            <h2 className="text-xl font-bold text-foreground mb-2">Beitrag nicht gefunden</h2>
          ...
          <div className="bg-background md:rounded-2xl md:shadow-sm md:border md:border-border overflow-hidden">
            <FeedCard 
              post={post} 
